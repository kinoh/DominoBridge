// Modified by Kino <http://kinon.sakura.ne.jp/>
// Fix According to https://github.com/milk-cocoa/document/wiki/API-%28Javascript%29
...
declare module milkcocoa
{
	class MilkCocoa
	{
		...
		anonymous(callback?: (error: number, user: {id: string}) => void): void;
